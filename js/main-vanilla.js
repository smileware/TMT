...
function createSlider(slider_id, view_m, view_d, center_m, center_d) {
  ...
  var shouldLoop = !slider_wrapper.classList.contains('-noloop');
...
// Change Play Icon on Product page 
var playIcons = document.querySelectorAll(".kb-svg-icon-fe_playCircle");
if(playIcons) {
